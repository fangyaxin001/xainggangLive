<template>
	<view>
		<u-navbar title="修改支付密碼"></u-navbar>
		<!-- 下一步 -->
		<view  v-show="flag" >
			<view class="set-pass">
		...
		<view v-show="!flag">
			...
			<view class="newpassword">
				<u-field style="height: 100rpx;"label-width="200"  v-model="passwords" label="確認新密碼" placeholder="請再次輸入新密碼">
				</u-field>
			</view>
		
			<view class="bottom-sub" @click="subimt">提交</view>
		</view>
	</view>
</template>
